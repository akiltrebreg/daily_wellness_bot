...
if not API_TOKEN or not WEATHER_API_KEY or not CALORIES_BURNED_API_KEY:
    raise ValueError("Необходимо указать BOT_TOKEN и WEATHER_API_KEY и CALORIES_BURNED_API_KEY в .env файле.")